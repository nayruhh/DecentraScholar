...
> These screenshots correspond to the appendix sections of the design report.
> Export them from the PDF appendices and place them under `docs/screenshots/` to render the images below.

### A — Reader / General User Flow

**A1 — Landing page**
![Landing page](docs/screenshots/A1-landing.png)

**A2 — Wallet connection and email verification**
![Wallet connection and email verification](docs/screenshots/A2-wallet-connect.png)

**A3 — OTP retrieval from dev log**
![OTP retrieval from dev log](docs/screenshots/A3-otp.png)

**A4 — Dashboard My Library tab**
![Dashboard My Library tab](docs/screenshots/A4-library.png)

**A5 — Dashboard My Profile tab**
![Dashboard My Profile tab](docs/screenshots/A5-profile.png)

**A6 — DST top-up and wallet events**
![DST top-up and wallet events](docs/screenshots/A6-topup.png)

**A7 — DST balance loaded on profile**
![DST balance loaded on profile](docs/screenshots/A7-balance.png)

**A8 — Paper in Browse Papers tab**
![Paper in Browse Papers tab](docs/screenshots/A8-browse.png)

**A9 — Paper details (save, rate, cite, IPFS view)**
![Paper details](docs/screenshots/A9-paper-detail.png)

### B — Author Workspace Flow

**B1 — Paper upload form**
![Paper upload form](docs/screenshots/B1-upload.png)

**B2 — Submission fee disclosure**
![Submission fee disclosure](docs/screenshots/B2-fee.png)

**B3 — MetaMask fee confirmation**
![MetaMask fee confirmation](docs/screenshots/B3-metamask-fee.png)

**B4 — MetaMask registry confirmation**
![MetaMask registry confirmation](docs/screenshots/B4-metamask-registry.png)

**B5 — Submission in progress**
![Submission in progress](docs/screenshots/B5-submitting.png)

**B6 — IPFS upload confirmation**
![IPFS upload confirmation](docs/screenshots/B6-ipfs.png)

**B7 — Paper pending review**
![Paper pending review](docs/screenshots/B7-pending.png)

**B8 — Review feedback revealed**
![Review feedback revealed](docs/screenshots/B8-feedback.png)

**B9 — Paper marked published**
![Paper marked published](docs/screenshots/B9-published.png)

### C — Reviewer Workspace Flow

**C1 — Assignment notification**
![Assignment notification](docs/screenshots/C1-assignment.png)

**C2 — Accept review and stake DST**
![Accept review and stake DST](docs/screenshots/C2-accept-stake.png)

**C3 — Submit blind review**
![Submit blind review](docs/screenshots/C3-submit.png)

**C4 — Review CID pinned to IPFS**
![Review CID pinned to IPFS](docs/screenshots/C4-ipfs-pin.png)

**C5 — Review session completed**
![Review session completed](docs/screenshots/C5-complete.png)

### D — Design Diagrams

**D1 — Use Case Diagram**
![Use Case Diagram](docs/screenshots/D1-use-case.png)

**D2 — Sequence Diagram**
![Sequence Diagram](docs/screenshots/D2-sequence.png)

**D3 — Database Schema**
![Database Schema](docs/screenshots/D3-schema.png)
